...
?>
	...
	<div id="content">
		...
		<div id="columnWrap">
			...
			<h1>Entities Index</h1>
			<p>Entities are businesses or organizations to which Kinara Capital has issued or may issue a loan.</p>
			<p>You may search using entity name or contact name.</p>
			
			<form id="searchForm" action="" method="get">
				<p><label for="s">Search:</label> <input type="text" name="s" class="search" value="<?php echo (isset($_GET['s'])?$_GET['s']:'Enter search term'); ?>" /> <button type="submit" class="yt"><span class="lsf">search</span>Submit Search</button></p>
			</form>
			...
			foreach( $entities as $entity ){
				$count++;
					...
					$output .= '<td class="entityName">' . $entity['entity'] .  '</td>';
			...
			<h1>Entities Index</h1>
			<p>An entity is a business or organization to which Kinara Capital has issued a loan. Browse all entities 
